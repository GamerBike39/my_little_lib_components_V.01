...
export const CurveSectionCta = ({
  title,
  subtitle,
  cta,
  picture,
  children,
}: CurveSectionCtaProps) => {
  return (
    <div className="relative">
      <img
        ...
        alt=""
      />
      <div className="relative bg-opacity-75 bg-purple-700/20">
        <svg
            ...
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              ...
              {cta && (
                <Link
                  href={cta?.link || ""}
                  aria-label=""
                  className="inline-flex items-center font-semibold tracking-wider transition-colors duration-200 text-teal-400 hover:text-teal-100"
                >
                  {cta?.text || ""}
                  <svg
